            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                ...
                <div class="pure-g">
                    <div class="pure-u-1 pure-u-md-1-3">
                        ...
                        <input type="text" name="author" id="author" class="comment-input " value="<?php $this->remember('author'); ?>" required
                        />
                    </div>
                    <div class="pure-u-1 pure-u-md-1-3">
                        ...
                        <input type="email" name="mail" id="mail" class="comment-input " value="<?php $this->remember('mail'); ?>" <?php if ($this->options->commentsRequireMail): ?> required
                        <?php endif; ?> />
                    </div>
                    <div class="pure-u-1 pure-u-md-1-3">
                        ...
                        <input type="url" name="url" id="url" class="comment-input " placeholder="<?php _e('http://'); ?>" value="<?php $this->remember('url'); ?>"
